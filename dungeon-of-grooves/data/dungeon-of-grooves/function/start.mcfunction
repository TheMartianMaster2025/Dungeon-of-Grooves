...
execute as @a[scores={class=3}] run give @s goat_horn[custom_data={instrument:true,class:guitar},instrument={use_duration:0.5,sound_event:"block.note_block.banjo",range:1,description:"Guitar"},use_cooldown={seconds:0.5,cooldown_group:horn}]
