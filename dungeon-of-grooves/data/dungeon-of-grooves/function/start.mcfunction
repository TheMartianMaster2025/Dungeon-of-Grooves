...
execute as @a[scores={class=9}] run give @s goat_horn[custom_data={instrument:true,class:cello},instrument={use_duration:0.3,sound_event:"block.note_block.bass",range:1,description:"Cello"},use_cooldown={seconds:0.3,cooldown_group:horn}]
